...
const Vision = () => {
    return (
        <div className='bg-offWhite xl:min-h-[746px] py-16 flex flex-col justify-center items-center Vision relative overflow-hidden'>
            ...
            <Image src="/assets/images/webp/white-vector.webp" alt="vector" width={39} height={271} sizes="(max-width: 640px) 50vw, (min-width: 641px) and (max-width: 1024px) 30vw, 39px" className="right-0 sm:w-[39px] w-5 sm:h-[271px] h-[200px] absolute bottom-[10%] sm:bottom-[15%]" />
        </div>
    )
}
