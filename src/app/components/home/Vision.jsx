...
const Vision = () => {
    return (
        <div className='bg-offWhite xl:min-h-[746px] py-16 flex flex-col items-center relative'>
            <Image src='/assets/images/webp/our-vision.png' className='left-0 max-w-[500px] xl:max-w-[701px] w-full lg:absolute lg:top-1/2 lg:-translate-y-1/2' alt='our-vision' width={100} height={100} />
