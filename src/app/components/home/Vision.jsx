    ...
    return (
        <div className='bg-offWhite xl:min-h-[746px] py-16 flex flex-col justify-center items-center Vision relative' id='vision'>
            <div className="max-w-[1440px] mx-auto h-full w-full relative flex flex-col items-center">
                <Image src='/assets/images/webp/our-vision.webp' style={{ width: 'auto', height: 'auto' }} className='left-0 image max-w-[500px] xl:max-w-[701px] w-full lg:absolute lg:top-1/2 lg:-translate-y-1/2' alt='our-vision' width={701} height={602} />
            ...
            <Image src='/assets/images/webp/white-vector.webp' style={{ width: 'auto', height: 'auto' }} alt='vector' width={39} height={271} className='right-0 sm:w-[39px] w-5 sm:h-[271px] h-[200px] absolute bottom-[10%] sm:bottom-[15%]' />
        </div>
    )
}
