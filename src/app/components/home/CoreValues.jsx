        ...
        <div className='relative py-20 CoreValues overflow-hidden'>
            <div className="container sm:py-10 relative z-[2]">
                ...
                <div className="md:mt-14 mt-6 relative flex flex-col items-center gap-11">
                    <Image loading="lazy" src="/assets/images/webp/work-tourism.webp" alt="work-tourism" className="w-full img max-w-[286px] lg:max-w-[259px] lg:absolute lg:top-1/2 lg:left-1/2 lg:-translate-y-1/2 lg:-translate-x-1/2" width={259} height={346} sizes="(max-width: 640px) 80vw, (min-width: 641px) and (max-width: 1024px) 50vw, 286px" />
            ...
            <Image loading="lazy" src="/assets/images/webp/value-vector.webp" alt="vector" width={55} height={343} sizes="(max-width: 640px) 50vw, (min-width: 641px) and (max-width: 1024px) 30vw, 55px" className="left-0 absolute top-[17%] hidden md:flex" />
            <Image loading="lazy" src="/assets/images/webp/value-bottom-img.webp" alt="value-bottom-img" width={1440} height={271} sizes="(max-width: 640px) 100vw, (min-width: 641px) and (max-width: 1024px) 80vw, 1440px" className="left-1/2 -translate-x-1/2 max-w-[1440px] absolute bottom-0 translate-y-1/2 object-cover h-[271px]" />
        </div>
    )
}
