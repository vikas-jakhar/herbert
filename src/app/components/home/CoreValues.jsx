        ...
        <div className='relative py-20 CoreValues'>
            <div className="container py-10">
                ...
                <div className="mt-14 relative flex flex-col items-center gap-11">
                    <Image src='/assets/images/webp/work-tourism.png' className='w-full img max-w-[286px] lg:max-w-[259px] lg:absolute lg:top-1/2 lg:left-1/2 lg:-translate-y-1/2 lg:-translate-x-1/2' alt='work-tourism' width={100} height={100} />
