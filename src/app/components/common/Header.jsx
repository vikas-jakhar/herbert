            ...
            <div className="container">
                <nav className="flex items-center justify-between">
                    <a href="/" className="w-fit relative z-20">
                        <Image src="/assets/images/webp/herbert-logo.webp" className="sm:max-w-[180px] navBar max-w-[117px] w-full" alt="herbert-logo" width={180} height={54} />
                    </a>
                    ...
                    <div role="button" aria-expanded={open} onClick={ToggleOpen} className={`${open ? "rounded-full shadow-5xl h-6" : ""} w-6 h-4 relative sm:hidden flex z-20 cursor-pointer duration-300 ease-linear`}>
                        <div className="">
