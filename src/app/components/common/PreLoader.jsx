    ...
    return (
        <div className="fixed inset-0 z-[150] flex items-center justify-center">
            ...
            <div className={`relative z-[200] animate-bounce flex flex-col sm:flex-row gap-10 items-center justify-center ${hide ? 'opacity-0' : 'opacity-100'}`}>
                <Image loading="lazy" src="/assets/images/webp/herbert-logo.webp" style={{ width: 'auto', height: 'auto' }} className="sm:max-w-[180px] max-w-[117px] w-full" alt="herbert-logo" width={180} height={54} />
