const PrimaryButton = (props) => {
    return (
        <div className={`${props.gsapClass} flex`}>
            <button className={`py-[11px] overflow-hidden hover:shadow-black-border px-6 group font-rubik font-semibold relative z-[1] duration-300 border border-transparent ease-linear text-base rounded-lg ${props.className}`}>
