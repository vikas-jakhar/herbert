const PrimaryButton = (props) => {
    return (
        <div className={`${props.gsapClass} flex`}>
            <button className={`sm:py-[11px] py-3 overflow-hidden hover:shadow-black-border px-6 group font-rubik font-semibold relative z-[1] duration-300 border border-transparent ease-linear text-sm sm:text-base rounded-lg ${props.className}`}>
